...
# -------------------------------------------------------------------------------------------------------------------------------
    ...
    def whose_turn(x):
        if x:
            if x == "ship1":
                screen.blit(Ship2, (750, 300))
            if x == "ship2":
                screen.blit(Ship3, (750, 300))
            if x == "ship3":
                screen.blit(Ship4, (750, 300))
            if x == "ship4":
                screen.blit(Ship5, (750, 300))
            if x == "ship5":
                screen.blit(Ship6, (750, 300))
            if x == "ship6":
                screen.blit(Ship1, (750, 300))
    ...
    while running:  # ------ Keep on running the game unless player presses quit--------#
        ...
        for event in pygame.event.get():  # --------Looping over all the events in the game---------#
            ...
            if event.type == pygame.MOUSEBUTTONUP:  # -----If user presses mouse button-----------#
                ...
                if 769 <= pos[0] <= 978 and 594 <= pos[1] <= 666:
        ...
        # ----updated X-cordinate of Batman--------#
        ship1_x = players["ship1"][0]
        # ----updated Y-cordinate of Batman--------#
        ship1_y = players["ship1"][1]
        # ----updated X-cordinate of Superman--------#
        ship2_x = players["ship2"][0]
        # ----updated Y-cordinate of Superman--------#
        ship2_y = players["ship2"][1]
        # ----updated X-cordinate of Superman--------#
        ship3_x = players["ship3"][0]
        # ----updated Y-cordinate of Superman--------#
        ship3_y = players["ship3"][1]
        # ----updated X-cordinate of Superman--------#
        ship4_x = players["ship4"][0]
        # ----updated Y-cordinate of Superman--------#
        ship4_y = players["ship4"][1]
        # ----updated X-cordinate of Superman--------#
        ship5_x = players["ship5"][0]
        # ----updated Y-cordinate of Superman--------#
        ship5_y = players["ship5"][1]
        # ----updated X-cordinate of Superman--------#
        ship6_x = players["ship6"][0]
        # ----updated Y-cordinate of Superman-----
        ship6_y = players["ship6"][1]
